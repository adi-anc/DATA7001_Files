getwd()
setwd("C:\\Users\\adijo\\Desktop\\NationalCrisis\\Airbnb Datasets\\Western Australia WA")
...
listings_sum <- listings[c(1, 4, 27, 28, 30, 31, 32, 33, 40, 56)]
listings_sum$city <- 'western australia'
...
avg_price_month$state <- 'western australia'
...
avg_price_month_in$state <- 'western australia'
