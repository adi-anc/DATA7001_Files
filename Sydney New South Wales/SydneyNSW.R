getwd()
setwd("C:\\Users\\adijo\\Desktop\\NationalCrisis\\Airbnb Datasets\\Sydney New South Wales")
...
listings_sum <- listings[c(1,4, 39, 40, 42, 44, 46, 49, 50, 52, 61, 83)]
listings_sum$city <- 'Sydney'
...
monthly_aggregates$city <- 'Sydney'
...
monthly_neighbourhood_aggregates$city <- 'sydney'
...
write.csv(listings_sum_inlier, 'sydney_listings-inlier.csv') 
write.csv(monthly_aggregates, 'sydney_monthly_agg_in.csv') 
write.csv(monthly_neighbourhood_aggregates, "sydney_monthly_neighbourhood_agg_in.csv")
