getwd()
setwd("C:\\Users\\adijo\\Desktop\\NationalCrisis\\Airbnb Datasets\\Barossa Valley South Australia")
...
listings_sum <- listings[c(1, 4, 28, 30, 31, 40, 56)]
listings_sum$city <- 'Barossa Valley'
...
avg_price_month_in$state <- 'New South Wales'
...
avg_price_neighbourhood_month_in$state <- 'New South Wales'
